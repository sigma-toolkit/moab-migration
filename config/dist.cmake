function(_moab_add_dist_targets)
  ...
  add_custom_target(dist_targz
    COMMAND "${CMAKE_COMMAND}" -DMODE=archive -DARCHIVE_FORMAT=gz
      ${_dist_sign_args} ${_dist_script_args}
    COMMENT "Generating provenance-named tar.gz archive${_dist_sign_comment}..."
    VERBATIM)
  add_custom_target(dist_tarbz2
    COMMAND "${CMAKE_COMMAND}" -DMODE=archive -DARCHIVE_FORMAT=bz2
      ${_dist_sign_args} ${_dist_script_args}
    COMMENT "Generating provenance-named tar.bz2 archive${_dist_sign_comment}..."
    VERBATIM)
  add_custom_target(dist_tarxz
    COMMAND "${CMAKE_COMMAND}" -DMODE=archive -DARCHIVE_FORMAT=xz
      ${_dist_sign_args} ${_dist_script_args}
    COMMENT "Generating provenance-named tar.xz archive${_dist_sign_comment}..."
    VERBATIM)
...
elseif(MODE STREQUAL "clean")
  ...
  file(REMOVE_RECURSE "${dist_dir}")
  file(REMOVE "${artifact_file}" ${archives})
endif()
